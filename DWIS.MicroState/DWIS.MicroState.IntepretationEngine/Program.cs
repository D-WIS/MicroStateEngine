...
namespace DWIS.MicroState.InterpretationEngine
{
    public class Engine
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            await engine.ConnectAndSubscribeReceiverAsync();
            await engine.ConnectAndSubscribeEmitterAsync();
            Console.WriteLine("when finished hit return");
            Console.ReadLine();
            if (engine.mqttClient_ != null)
            {
                await engine.mqttClient_.DisconnectAsync();
            }
        }
        ...
        public Engine()
        {
            ...
            thresholds_.StableAxialVelocityTopOfStringThreshold = 0.01;
            thresholds_.StableRotationalVelocityTopOfStringThreshold = 0.1 / 60.0;
            ...
            thresholds_.StableFlowAnnulusOutletThreshold = 50.0 / 60000.0;
            ...
            thresholds_.StableAxialVelocityBottomOfStringThreshold = 0.05;
            thresholds_.StableFlowBottomOfStringThreshold = 20.0 / 60000.0;
            thresholds_.StableFlowHoleOpenerThreshold = 20.0 / 60000.0;
            ...
            System.Timers.Timer timer = new System.Timers.Timer(signals_.MaximumBindingRefreshInterval.TotalMilliseconds);
        ...
        private bool ProcessSignals()
        {
            ...
            if (signals_ != null)
            {
                if (signals_.AxialVelocityTopOfString != null)
                {
                    ...
                    {
                        SignalMapping mapping = signalDictionary_[ID];
                        if (mapping != null && mapping.Value != null && mapping.Value is double)
                        {
                            uint code = 0;
                            if ((double)mapping.Value > 0)
                            {
                                code = 1;
                            }
                            else if ((double)mapping.Value == 0)
                            {
                                code = 2;
                            }
                            else
                ...
                if (signals_.StandardDeviationAxialVelocityTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableAxialVelocityTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else 
                ...
                if (signals_.StandardDeviationRotationalVelocityTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableRotationalVelocityTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationFlowTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableFlowTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                    ...
                    signals_.ForceElevator != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID1) && signalDictionary_.ContainsKey(ID2) && signalDictionary_.ContainsKey(ID3))
                    {
                        ...
                        if (mapping1 != null && mapping1.Value != null && mapping1.Value is double &&
                            ...
                            mapping3 != null && mapping3.Value != null && mapping3.Value is double)
                        {
                            uint code = 0;
                            if (Numeric.EQ((double)mapping1.Value, (double)mapping2.Value) || Numeric.EQ((double)mapping1.Value, (double)mapping3.Value))
                            {
                                code = 1;
                            }
                            else if (!Numeric.EQ((double)mapping1.Value, 0) && Numeric.EQ((double)mapping2.Value, 0) && Numeric.EQ((double)mapping3.Value, 0))
                            {
                                code = 2;
                            }
                            else
                ...
                if (signals_.StandardDeviationTensionTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableTensionTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.PressureTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > Constants.EarthStandardAtmosphericPressure)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationPressureTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StablePressureTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationTorqueTopOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableTorqueTopOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationFlowAnnulusOutlet != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableFlowAnnulusOutletThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationForceBottomOfStringOnRock != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableBottomOfStringRockForceThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationRotationalVelocityBottomOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableRotationalVelocityBottomOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StandardDeviationAxialVelocityBottomOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableAxialVelocityBottomOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StableFlowBottomOfString != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableFlowBottomOfStringThreshold)
                            {
                                code = 1;
                            }
                            else
                ...
                if (signals_.StableFlowHoleOpener != null)
                {
                    ...
                    if (signalDictionary_.ContainsKey(ID))
                    {
                        ...
                        {
                            uint code = 0;
                            if ((double)mapping.Value > thresholds_.StableFlowHoleOpenerThreshold)
                            {
                                code = 1;
                            }
                            else
