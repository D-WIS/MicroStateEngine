...
namespace DWIS.MicroState.Model
{
    ...
    public class Calibrations
    {
        ...
        public Dictionary<PropertyInfo, Dictionary<DWISNodeID, CalibrationParameters>> Values { get; set; } = new Dictionary<PropertyInfo, Dictionary<DWISNodeID, CalibrationParameters>>();
