...
flowchart TD
	...
	DWIS:UCS_bh_01([DWIS:UCS_bh_01]) -- http://ddhub.no/IsOfMeasurableQuantity --> DWIS:FormationStrength([DWIS:FormationStrength]):::quantityClass
...
flowchart TD
	...
	DWIS:UCSSlope_bh_01([DWIS:UCSSlope_bh_01]) -- http://ddhub.no/IsOfMeasurableQuantity --> DWIS:DrillingPressureGradient([DWIS:DrillingPressureGradient]):::quantityClass
